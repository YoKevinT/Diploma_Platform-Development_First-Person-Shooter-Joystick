...
public class CameraLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //euler.x -= Input.GetAxis("Mouse Y") * speed.x * Time.deltaTime;

        // Rotate the camera based on Joystick Movement
        euler.y += joystick.Horizontal * speed.x * Time.deltaTime;
        euler.x -= joystick.Vertical * speed.x * Time.deltaTime;
